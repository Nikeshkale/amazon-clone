...
function Payment() {
  ...
  //  const stringClientSecret = clientSecret.toString();
    ...
    useEffect(() => {
        //generate the special stripe serect which allows us to change a customer

        const getClientSecret = async () => {
            const response = await axios({
                method:'post',
                // stripe expect the total in a currencies subnits
